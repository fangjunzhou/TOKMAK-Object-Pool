...
namespace kTools.Pooling
{
    public static class PoolingSystem
    {
        ...
        private static readonly List<Pool> s_Pools;
        private static readonly List<Processor> s_Processors;
        ...
        public static void CreatePool<T>(object key, T source, int instanceCount, bool expandable = false)
        {
            // Test argument validity
            if (key == null)
            {
            ...
            // Create Pool
            var pool = new Pool<T>(key, source, instanceCount, processor, expandable);
            s_Pools.Add(pool);
        }
        ...
        private static void GatherProcessors()
        {
        ...
        private static bool TryGetProcessor<T>(out Processor<T> value)
        {
